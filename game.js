...
(function(pa) {
    ...
    class q {
        ...
        static Tp(a, b) {
            ...
            null != b && (c.Hc = w.J(b, D));
            null != d && (c.o = w.J(d, D));
            null != f ? c.wb = w.J(f, D) : null != e && c.Vc(w.J(e, D));
        ...
        static Qp(a, b) {
            ...
            e = b.x - d.x,
            b = b.y - d.y,
            c.fc = c.Jb = Math.sqrt(e * e + b * b))) : a instanceof Array ? (c.Jb = w.J(a[0], D),
            c.fc = w.J(a[1], D)) : c.fc = c.Jb = w.J(a, D);
    ...
    class ib {
        constructor() {
            this.Rb = -1;
            this.gb = new T(m.j.ii.v());
            this.Wc = new lc;
            this.f = x.Ia(ib.O);
            let a = x.Ba(this.f);
            this.Tb = new Rb(a.get("red-score"),0);
            this.Ob = new Rb(a.get("blue-score"),0);
    ...
    class Z {
        ...
        uc() {
            let a = va.Cc
              , b = this.ic;
            this.jc != a && (null == b && (this.ic = b = new Z),
            this.jc = a,
            Z.zd(b, this));
            return b
        }
    ...
    class aa {
        ...
        static Uq(a, b, c) {
            return aa.om(a, "POST", "json", b, c)
        }
        static Yl(a, b, c) {
            return aa.Uq(a, b, c).then(function(d) {
                let e = d.error;
                if (null != e)
                    throw v.C(e);
                return d.data
    ...
    class ua {
        ...
        uc() {
            let a = va.Cc
              , b = this.ic;
            this.jc != a && (null == b && (this.ic = b = new ua),
            this.jc = a,
            ua.zd(b, this));
            return b
        }
    ...
    class Ob {
        ...
        Ei(a) {
            ...
            a.Tl = function(d, e, f, g) {
                E.h(c.wq, d.Z);
                null == e ? d = "" + d.D + " has left" : (Wb.h(c.vq, d.Z, e, null != g ? g.D : null, f),
            ...
            ;
            a.Rl = function(d) {
                c.l.Ka.Ib("" + d.D + " " + (d.Vd ? "has desynchronized" : "is back in sync"))
            }
            ;
            a.Wl = function(d, e, f) {
    ...
    class lb {
        ...
        hm() {
            let a = this;
            aa.Nk(m.Se + "api/notice").then(function(b) {
                let c = b.content;
    ...
    class Ub {
        ...
        static st(a, b) {
            ...
            for (; d < b.length; ) {
                ...
                ++d;
                let f = e.Ed;
                e.Ze = 6378 * Ub.Ws(.017453292519943295 * f.Jc, .017453292519943295 * f.Mc, .017453292519943295 * c, .017453292519943295 * a);
                isFinite(e.Ze) || (e.Ze = 22E3)
            }
        }
        static get() {
            return aa.v(m.Se + "api/list", "arraybuffer").then(function(a) {
    ...
    class ca {
        constructor(a) {
            ...
            let c = this;
            wb.Np().then(function(d) {
                null == ca.Kg && (ca.Kg = window.document.createElement("div"),
                b.fe.appendChild(ca.Kg),
                ca.kr = d.render(ca.Kg, {
                    sitekey: a,
                    callback: function(e) {
                        E.h(ca.fm, e)
                    },
    ...
    class Va {
        ...
        hl(a) {
            ...
            b = this.Lc.scrollTop + b - this.Lc.scrollHeight >= .5 * -b || !Va.Dp(this.Lc);
    ...
    class zb {
        constructor() {
            ...
            this.Eb.onkeydown = function(c) {
                13 == c.keyCode && b.Ic() && null != b.Wa && b.Wa(b.Eb.value)
            }
            ;
            this.rf.onclick = function() {
                b.Ic() && null != b.Wa && b.Wa(b.Eb.value)
            }
            ;
            this.A()
        }
    ...
    class Ab {
        ...
        Xi(a) {
            ...
            null == a && (a = "");
            let d = this;
            aa.Yl(this.hs, "token=" + this.Ff + "&rcr=" + a, aa.Lj).then(function(e) {
                switch (e.action) {
                case "connect":
                    c(e);
                    break;
        ...
        Xh(a) {
            let b = a.jb(), c = ha.Ls(a.tb(a.F())), d, e, f;
            try {
        ...
        wp(a, b, c, d, e, f) {
            if (16 <= this.xd.size)
                ...
                var k = new Na(a,this.kg,this.oo);
                f && (k.wk = 2500);
                k.Ae = g;
                k.rd = b;
                this.xd.set(a, k);
    ...
    class ya {
        ...
        uc() {
            let a = va.Cc
              , b = this.ic;
            this.jc != a && (null == b && (this.ic = b = new ya),
            this.jc = a,
            ya.zd(b, this));
            return b
        }
    ...
    class wb {
        static Np() {
            if (null != wb.yi)
                return wb.yi;
            wb.yi = new Promise(function(a, b) {
    ...
    class za {
        ...
        Vs() {
            let a = va.Cc
              , b = this.Bn;
            this.Cc != a && (null == b && (this.Bn = b = new za),
            this.Cc = a,
            za.Ms(b, this));
            return b
        }
    ...
    class la {
        ...
        static kp() {
            return aa.Nk(m.Se + "api/geo").then(function(a) {
                return la.gg(a)
            })
        }
    }
    ...
    class U {
        ...
        static cp() {
            try {
                return window.crypto.subtle.generateKey(U.vh, !0, ["sign", "verify"]).then(function(a) {
                    let b = a.privateKey;
        ...
        static bp(a) {
            ...
            let b = a[1]
              , c = a[2]
              , d = a[3];
            return U.Is(b, c, d).then(function(e) {
                let f = new U;
                f.nj = b;
                f.oj = c;
                f.uk = d;
        ...
        static Bs(a, b) {
            try {
                ...
                return U.Hs(g, h).then(function(n) {
    ...
    class Eb {
        constructor(a) {
            function b() {
                d.Ic() && null != d.Bl && d.Bl(d.Eb.value)
            }
            this.f = x.Ia(Eb.O);
            let c = x.Ba(this.f);
            this.Eb = c.get("input");
    ...
    class Fb {
        constructor(a) {
            ...
            this.df.onclick = function() {
                qc.h(c.ri, c.Rb, c.Bi.value, c.ak)
            }
            ;
    ...
    class I {
        ...
        Vc(a) {
            ...
            a > I.Nn && a < I.Mn && (this.wb = 1 / Math.tan(a / 2))
        }
        hp() {
    ...
    class Gc {
        ...
        static v() {
            return Gc.xf(window.top.location.search)
        }
    }
    class Hc {
        static Ym(a, b) {
    ...
    class Pa {
        constructor(a) {
            ...
            this.Od = null;
            this.Re = 0;
            this.po = new Db(3,1E3);
            this.W = new Nb;
            this.Ng = "Waiting for link";
            this.Ki = this.zm = !1;
            this.Bd = 0;
            let b = this;
            this.dg = new cc(a,function(d) {
                b.l.Ka.Ib(d)
            }
            );
            this.za = a;
            ...
            this.Rh = new Ob(this.l,a.U.oa(a.xc).D);
            this.Rh.Ei(a.U);
        ...
        static wm(a) {
            let b = new Date;
            dc.Jr(a, "HBReplay-" + b.getFullYear() + "-" + Y.Of("" + (b.getMonth() + 1)) + "-" + Y.Of("" + b.getDate()) + "-" + Y.Of("" + b.getHours()) + "h" + Y.Of("" + b.getMinutes()) + "m.hbr2")
        }
        static ir(a) {
            var b = a.U.K;
            let c = [];
    ...
    class B {
        ...
        static Op() {
            let a = m.j.Yj.v();
            null == a ? U.cp().then(function(b) {
                B.Xe = b;
                m.j.Yj.ha(b.ss())
            }).catch(function() {}) : U.bp(a).then(function(b) {
                return B.Xe = b
            }).catch(function() {})
        }
        static gp() {
        ...
        static So(a, b) {
            ...
            let e = null;
            e = function(f, g) {
                aa.Yl(m.Se + "api/client", "room=" + f + "&rcr=" + g, aa.Lj).then(function(h) {
                    switch (h.action) {
                    case "connect":
                        h = h.token;
                        if (null == h)
        ...
        static er() {
            let a = Gc.v()
              ...
              , c = a.get("p");
            a.get("v");
            null != b ? null != c ? B.Mh(b) : B.eg(b) : B.yb()
        }
        static yb() {
            let a = new Ua(m.j.Th());
            C.Na(a.La);
        ...
        static Mh(a) {
            ...
            C.Na(b.f);
            b.Wa = function(c) {
                null == c ? B.yb() : B.eg(a, c)
            }
        }
        static Uo(a) {
            try {
                let b = new hc(new fc(new Uint8Array(a),new ya,3));
                b.te.oe = function() {
                    b.la();
                    B.yb()
                }
                ...
                if (c instanceof $b)
                    ...
                    a.Wa = function(d) {
                        ...
                        window.top.open(d.protocol + "//" + d.hostname + (null != d.port ? ":" + d.port : "") + "/replay?v=" + c.Sd, "_self")) : B.yb()
                    }
                    ;
                else {
    ...
    class cc {
        ...
        xf(a) {
            ...
            case "store":
                let f = this.za.U.T;
                f.cf() ? this.da("Can't store default stadium.") : Ib.pt().then(function() {
                    return Ib.add(f)
                }).then(function() {
                    c.da("Stadium stored")
                }, function() {
                ...
                if (!(1 > e.length)) {
                    ...
                    f.onload = function() {
                        try {
                            ...
                            g = v.Mb(h).Gb(),
                            g instanceof SyntaxError ? E.h(b.si, "SyntaxError in line: " + R.Je(g.lineNumber)) : g instanceof Sa ? E.h(b.si, g.cq) : E.h(b.si, "Error loading stadium file.")
                        }
                    }
                    ;
                    f.readAsText(e)
        ...
        static get(a) {
            return null == window.indexedDB ? Promise.reject("IndexedDB not supported by browser.") : new Promise(function(b, c) {
                ...
                d.onsuccess = function() {
                    ...
                    ;
                    Xb.ph(f.objectStore("files").get(a)).then(function(g) {
                        try {
                            let h = new q;
                            h.el(g);
                            b(h)
        ...
        static getAll() {
            return null == window.indexedDB ? Promise.reject("IndexedDB not supported by browser.") : new Promise(function(a, b) {
                ...
                c.onsuccess = function() {
                    ...
                    ;
                    Xb.ph(e.objectStore("meta").getAll()).then(a, b)
                }
            }
            )
        }
        ...
        static add(a) {
            return null == window.indexedDB ? Promise.reject("IndexedDB not supported by browser.") : new Promise(function(b, c) {
                ...
                d.onsuccess = function() {
                    ...
                    ;
                    try {
                        Xb.ph(f.objectStore("files").add(a.De())).then(function(g) {
                            g = {
                                name: a.D,
                                id: g
                            };
                            return Xb.ph(f.objectStore("meta").add(g))
                        }).catch(c)
                    } catch (g) {
                        c(0)
                    }
    ...
    class Bb {
        constructor() {
            ...
            this.$j = this.sb.createPattern(this.sb.canvas, "no-repeat");
            this.Lo()
        }
        Lo() {
            let a = window.document.createElement("canvas");
        ...
        A(a, b) {
            if (null != a.I) {
                let c = m.j.Vm.v() ? b.mb[a.fa.ba] : a.fa.Um
                  ...
                  , e = m.j.Km.v() && null != d;
                if (!Bb.ro(this.mb, c) || !e && a.Nb != this.zh || e && this.Zf != d)
                    Bb.Ho(this.mb, c),
                    e ? (this.Zf = d,
        ...
        pr(a) {
            ...
            if (!(1 > b.length)) {
                ...
                for (var c = -32, d = 64 / b.length, e = 0; e < b.length; )
                    this.sb.fillStyle = T.nc(b[e++]),
                    this.sb.fillRect(c, -32, d + 4, 64),
                    c += d;
                this.sb.restore();
                this.sb.fillStyle = T.nc(this.mb.pd);
        ...
        constructor(a) {
            function b(y) {
                ...
                for (; ea < L.length; ) {
                    let V = L[ea];
                    ++ea;
                    let yc = window.document.createElement("div");
                    var S = V;
                ...
                F.appendChild(L);
                L.onclick = function() {
                    zc.classList.toggle("show", !0);
                    zc.focus();
                    zc.onkeydown = function(V) {
                        zc.classList.toggle("show", !1);
                        V.stopPropagation();
                        V = V.code;
                        null == Jb.v(V) && (Jb.Pa(V, y),
                        m.j.Kd.ha(Jb),
                        Ic())
                    }
                }
        ...
        static Rn(a, b) {
            ...
            default:
                if (null != a)
                    ...
                    return !1;
                return b == Oc && null != a.b || b == Pc && null != a.Wf ? !0 : null != a.Hb ? Lb[a.Hb] == b : !1
            }
        }
        static Qn(a, b) {
    ...
    class Qa extends oa {
        ...
        Za(a, b) {
            ...
            c = function(e) {
                ...
                f.Xb(b.version);
                f.Fb(b.password);
                d.rc = new bc(b.yj,b.iceServers,a,wc.channels,f,b.Jn);
                d.rc.wh = e;
                d.rc.Id = function(h) {
                    d.rc = null;
                    d.ua = h;
    ...
    class ec extends oa {
        ...
        Za(a) {
            ...
            this.Oc = new Ab(this.$p,a.iceServers,wc.channels,a.Jn);
            ...
            U.Bs(c, a).catch(function() {
                ...
                try {
                    if (-1 != e.cc.indexOf(b)) {
                        ...
                        b.ba = g;
                        e.We.set(g, b);
                        Aa.h(e.oq, g, new K(new DataView(d.buffer,d.byteOffset,d.byteLength),!1));
                        b.Lg = !0;
                        e.Qr(b)
                    }
                } catch (h) {
    ...
    class fc extends oa {
        ...
        Za(a, b, c) {
            ...
            this.jr(this.Sc);
            c = this.Sc.tb();
            this.Sc = new K(new DataView(c.buffer,c.byteOffset,c.byteLength),!1);
            this.Hi();
    ...
    class Fa extends p {
        ...
        xa(a) {
            ...
            this.Zd = q.ma(new K(new DataView(a.buffer,a.byteOffset,a.byteLength)))
        }
        static qa(a) {
            let b = new Fa;
            b.Zd = a;
    ...
    class Ga extends p {
        ...
        apply(a) {
            if (a.Pb(this.P)) {
                var b = a.Ac;
                a.Ac = this.newValue;
                b != this.newValue && Aa.h(a.zt, a.oa(this.P), this.newValue)
            }
        }
        wa(a) {
    ...
    class $a extends p {
        ...
        apply(a) {
            ...
            if (null != b && a.Pb(this.P)) {
                ...
                d != this.Pf && qc.h(a.Ll, c, this.Pf, e)
            }
        }
        wa(a) {
            a.m(this.Pf ? 1 : 0)
    ...
    mb.zp = ["click-rail", "drag-thumb", "wheel", "touch"];
    p.zb = !1;
    p.qn = new Map;
    p.Nf = 0;
    W.zb = !1;
    ...
    aa.Lj = "application/x-www-form-urlencoded";
    ...
    da.Kn = new ac([0, 0, 2, 1, 0, .35, 1, 0, 1, 0, .7, 1, 0, 0, 0, 1]);
    da.Ln = new ac([0, -1, 3, 0, 0, .35, 0, 0, 0, 0, .65, 0, 0, 1, 3, 1]);
    Cb.O = "<div class='dialog change-location-view'><h1>Change Location</h1><div class='splitter'><div class='list' data-hook='list'></div><div class='buttons'><button data-hook='change'>Change</button><button data-hook='cancel'>Cancel</button></div></div></div>";
    Va.O = "<div class='chatbox-view'><div class='chatbox-view-contents'><div data-hook='drag' class='drag'></div><div data-hook='log' class='log subtle-thin-scrollbar'><div data-hook='log-contents' class='log-contents'><p>Controls:<br/>Move: WASD or Arrows<br/>Kick: X, Space, Ctrl, Shift, Numpad 0<br/>View: Numbers 1 to 4</p></div></div><div class='autocompletebox' data-hook='autocompletebox'></div><div class='input'><input data-hook='input' type='text' /></div></div></div>";
    Eb.O = "<div class='choose-nickname-view'><img src=\"images/haxball.png\" /><div class='dialog'><h1>Choose nickname</h1><div class='label-input'><label>Nick:</label><input data-hook='input' type='text' /></div><button data-hook='ok'>Ok</button></div></div>";
    Gb.O = "<div class='connecting-view'><div class='dialog'><h1>Connecting</h1><div class='connecting-view-log' data-hook='log'></div><button data-hook='cancel'>Cancel</button></div></div>";
    ...
    ib.O = "<div class='game-state-view'><div class='bar-container'><div class='bar'><div class='scoreboard'><div class='teamicon red'></div><div class='score' data-hook='red-score'>0</div><div>-</div><div class='score' data-hook='blue-score'>0</div><div class='teamicon blue'></div></div><div class=\"fps-limit-fix\"></div><div data-hook='timer'></div></div></div><div class='canvas' data-hook='canvas'></div></div>";
    qa.O = "<div class='game-view' tabindex='-1'><div class='gameplay-section' data-hook='gameplay'></div><div class='top-section' data-hook='top-section'></div><div class='bottom-section'><div data-hook='stats'></div><div data-hook='chatbox'></div><div class='bottom-spacer'></div></div><div class='buttons'><div class='sound-button-container' data-hook=\"sound\"><div class='sound-slider' data-hook='sound-slider'><div class='sound-slider-bar-bg' data-hook='sound-bar-bg'><div class='sound-slider-bar' data-hook='sound-bar'></div></div></div><button data-hook='sound-btn'><i class='icon-volume-up' data-hook='sound-icon'></i></button></div><button data-hook='menu'><i class='icon-menu'></i>Menu<span class='tooltip'>Toggle room menu [Escape]</span></button><button data-hook='settings'><i class='icon-cog'></i></button></div><div data-hook='popups'></div></div>";
    Fb.O = "<div class='dialog kick-player-view'><h1 data-hook='title'></h1><div class=label-input><label>Reason: </label><input type='text' data-hook='reason' /></div><button data-hook='ban-btn'><i class='icon-block'></i>Ban from rejoining: <span data-hook='ban-text'></span></button><div class=\"row\"><button data-hook='close'>Cancel</button><button data-hook='kick'>Kick</button></div></div>";
    qb.O = "<div class='dialog basic-dialog leave-room-view'><h1>Leave room?</h1><p>Are you sure you want to leave the room?</p><div class='buttons'><button data-hook='cancel'>Cancel</button><button data-hook='leave'><i class='icon-logout'></i>Leave</button></div></div>";
    rb.O = "<div class='dialog pick-stadium-view'><h1>Pick a stadium</h1><div class='splitter'><div class='list' data-hook='list'></div><div class='buttons'><button data-hook='pick'>Pick</button><button data-hook='delete'>Delete</button><div class='file-btn'><label for='stadfile'>Load</label><input id='stadfile' type='file' accept='.hbs,.json,.json5' data-hook='file'/></div><button data-hook='export'>Export</button><div class='spacer'></div><button data-hook='cancel'>Cancel</button></div></div></div>";
    Hb.O = "<div class='dialog' style='min-width:200px'><h1 data-hook='name'></h1><button data-hook='admin'></button><button data-hook='kick'>Kick</button><button data-hook='close'>Close</button></div>";
    xb.O = "<div class='player-list-item'><div data-hook='flag' class='flagico'></div><div data-hook='name'></div><div data-hook='ping'></div></div>";
    ...
    yb.O = "<div class='dialog basic-dialog room-link-view'><h1>Room link</h1><p>Use this url to link others directly into this room.</p><input data-hook='link' readonly></input><div class='buttons'><button data-hook='close'>Close</button><button data-hook='copy'>Copy to clipboard</button></div></div>";
    nb.Hj = "<tr><td><span data-hook='tag'></span><span data-hook='name'></span></td><td data-hook='players'></td><td data-hook='pass'></td><td><div data-hook='flag' class='flagico'></div><span data-hook='distance'></span></td></tr>";
    ...
    ob.O = "<div class=\"stats-view-container\"><div class='stats-view'><p data-hook='ping'></p><p data-hook='fps'></p><div data-hook='graph'></div></div></div>";
